...
type CoreClassAssertions = [
  ...
  Assert<IsExact<Parameters<Rendition["injectScript"]>, [doc: Document, section: Section]>>,
  Assert<IsExact<Parameters<Rendition["injectStylesheet"]>, [doc: Document, section: Section]>>,
  ...
  Assert<IsExact<Parameters<Contents["map"]>, [layout: MappingLayout]>>,
  Assert<IsExact<ReturnType<Contents["map"]>, EpubCFIPair[]>>,
...
type LayoutAssertions = [
  ...
  Assert<IsExact<EpubLayoutSettings["spread"], string | boolean | undefined>>,
  ...
  Assert<IsExact<Parameters<Layout["spread"]>, [spread?: string | boolean | undefined, min?: number | undefined]>>,
...
function testEpub() {
  ...
  const bookContainerPath: Promise<string> = book.openContainer("META-INF/container.xml");
  ...
  const layoutBooleanSpread: boolean = runtimeLayout.spread(true, 800);
  ...
  const contentsMap: EpubCFIPair[] = typedContents.map(contentsMappingLayout);

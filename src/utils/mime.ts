...
type MimeExtension = string | string[];
type MimeTable = Record<string, Record<string, MimeExtension>>;
...
var mimeTypes = (function(): MimeTypes {
	var type, subtype, val, index, mimeTypes: MimeTypes = {};
	for (type in table) {

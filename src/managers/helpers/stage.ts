...
type StyleRuleSet = Record<string, string | number>;
...
class Stage {
	...
	resizeFunc: ((event?: Event) => void) | undefined;
	orientationChangeFunc: ((event?: Event) => void) | undefined;
	...
	*/
	...
	onResize(func: (event?: Event) => void): void {
	...
	onOrientationChange(func: (event?: Event) => void): void {
		this.orientationChangeFunc = func;
		window.addEventListener("orientationchange", this.orientationChangeFunc, false);
	}

	size(width?: number | string | null | false, height?: number | string | null | false): StageSize {
		var bounds;
	...
	addStyleRules(selector: string, rulesArray: StyleRuleSet[]): void {
		var scope = "#" + this.id + " ";
		var rules = "";

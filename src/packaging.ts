...
class Packaging {
	 ...
	 */
	parseMetadata(xml: Element): PackagingMetadata {
		var metadata: PackagingMetadata = {};
	 ...
	 */
	parseManifest(manifestXml: Element): PackagingManifest {
	 ...
	 * @return {object} spine
	 */
	parseSpine(spineXml: Element, manifest: PackagingManifest): PackagingSpineItem[] {

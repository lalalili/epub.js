...
import epubDefault, { Book, Contents, EpubCFI, Layout, Rendition, parseSmilClock, parseSmilDocument, replaceBase, replaceCanonical, replaceLinks, replaceMeta, request, resolveSmilHref, substitute } from "epubjs";
...
\tconst expectedExports = ["Book", "Contents", "EpubCFI", "Layout", "Rendition", "default", "parseSmilClock", "parseSmilDocument", "replaceBase", "replaceCanonical", "replaceLinks", "replaceMeta", "request", "resolveSmilHref", "substitute"];
\tassert(
...
\tassert(typeof moduleExports.parseSmilClock === "function", entryName + " named parseSmilClock must be exposed");
\tassert(typeof moduleExports.parseSmilDocument === "function", entryName + " named parseSmilDocument must be exposed");
...
\tassert(typeof moduleExports.resolveSmilHref === "function", entryName + " named resolveSmilHref must be exposed");
...
assert(typeof parseSmilClock === "function", "bare ESM named parseSmilClock must be exposed");
assert(typeof parseSmilDocument === "function", "bare ESM named parseSmilDocument must be exposed");
...
assert(typeof resolveSmilHref === "function", "bare ESM named resolveSmilHref must be exposed");

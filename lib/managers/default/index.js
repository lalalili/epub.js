  ...
  scrollToLogicalPage(pageIndex, options = {}) {
    ...
    if (this.isRtlVerticalPaginated() && targetIndex >= nominalTotalPages) {
      ...
      for (let correctionAttempt = 1; correctionAttempt <= 2; correctionAttempt += 1) {
        ...
        let plannedContinuationAhead = (0, _pagination.getPlannedVerticalRlContinuationAhead)(this._verticalRlTerminalContinuationOffsets, targetIndex, nominalTotalPages, correctionOffset);
        ...
        let replacement = (0, _pagination.evaluateVerticalRlContinuationReplacement)({

...
class DefaultViewManager {
  ...
  scrollToLogicalPageInLayout(pageIndex, options = {}, preserveSourceCut = false) {
    ...
    if (terminalLayout && (0, _terminalContinuation.promoteVerticalRlTerminalContinuationWithObservation)(terminalLayout, this.getBaseGeometryPageCount(), targetIndex, logicalOffset, maxScroll, this.getPageSnapTolerance(), {

...
class DefaultViewManager {
  ...
  scrollToLogicalPageInLayout(pageIndex, options = {}) {
    ...
    if (terminalLayout && (0, _terminalContinuation.promoteVerticalRlTerminalContinuation)(terminalLayout, this.getBaseGeometryPageCount(), targetIndex, logicalOffset, maxScroll, this.getPageSnapTolerance())) {
      this._verticalRlPageIndexLookupKey = null;
    }

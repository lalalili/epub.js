                ...
                return book.ready.then(function() {
                        ...
                        return section.load().then(function() {
                                ...
                                [findResults , searchResults].forEach( (results)=>{
                                        ...
                                        assert.equal(stripChapterAssertion(results[0].cfi), "epubcfi(/6/8!/4/2/16,/1:275,/1:323)");
                ...
                return book.ready.then(function() {
                        ...
                        return section.load().then(function() {
                                ...
                                [findResults , searchResults].forEach( (results)=>{
                                        ...
                                        assert.equal(stripChapterAssertion(results[0].cfi), "epubcfi(/6/8!/4/2/8,/1:240,/1:252)");
                                        ...
                                        assert.equal(stripChapterAssertion(results[1].cfi), "epubcfi(/6/8!/4/2/20,/1:148,/1:160)");
        ...
        it("finds result that spanning multiple document nodes, tag at ending", function() {
                ...
                return book.ready.then(function() {
                        ...
                        return section.load().then(function() {
                                ...
                                assert.equal(stripChapterAssertion(searchResults[0].cfi), "epubcfi(/6/26!/4/2/6,/1:5,/2/1:3)");
        ...
        it("finds result that spanning multiple document nodes, tag at middle", function() {
                ...
                return book.ready.then(function() {
                        ...
                        return section.load().then(function() {
                                ...
                                const searchResults = section.search(queryString);
                                assert.equal(searchResults.length, 1);
                                assert.equal(stripChapterAssertion(searchResults[0].cfi), "epubcfi(/6/26!/4/2/6,/1:5,/3:12)");
